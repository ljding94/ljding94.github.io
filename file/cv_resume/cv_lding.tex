...
\begin{longtable}{@{}p{0.17\linewidth} p{0.78\linewidth}@{}}
    2017--2018 & Teaching Assistant, Basic Physics A and B (two semesters), Brown University \newline
                Led laboratory sessions and delivered short lectures; developed instructional materials, held office hours, and graded assignments\\
    Fall 2016  & Teaching Assistant, Mechanics and Thermal Physics, USTC \newline
                Provided one-on-one tutoring, held office hours, and graded assignments\\
    \multicolumn{2}{@{}l}{\textit{Mentoring}} \\
    Summer 2025 & Research Mentor, ORNL Summer Research Student Internship Program \newline
                   Mentored Simon Nirenberg (Brown University, Class of 2028) on Adaptive Autonomous Basin Climbing (ABC), with applications to two-dimensional models and Lennard--Jones systems; the project culminated in a poster and presentation.
\end{longtable}
...
\begin{longtable}{l p{0.76\linewidth}}
    ...
    Programming: & Python (PyTorch, CrewAI, Agent SDK, NumPy, Pandas, Scikit-learn), C/C++, CUDA, SQL \\~\\
    Domain Knowledge:& Agentic AI, Soft Matter Physics, Large Language Models, Deep Learning, Machine Learning, Physics-informed ML, Computational Physics, Small-Angle Scattering, Quantitative Finance
\end{longtable}
...
\begin{etaremune}
    \item \bibentry{ding2026llms}
    \item \bibentry{tung2026constrained}
    \item \bibentry{Tung2026optimalbinning}
    \item \bibentry{do2026binningverdict}
    \item \bibentry{ding2026colpack}
    \item \bibentry{Lee2026alignment}
    \item \bibentry{ding2026rods}
    \item \bibentry{ding2026sasagent}
...
\begin{etaremune}
    \item \bibentry{du2026protocolrouter}
\end{etaremune}
...
\begin{etaremune}
    ...
    \item \bibentry{wei2016trajectory}
\end{etaremune}
...
\begin{etaremune}
    \item Towards Autonomous Soft Matter Research. The 8th Open Reflectometry Standards Organization (ORSO) Annual Meeting, Argonne National Laboratory (Jul. 2026)
    \item Agentic AI and Physics-Informed Machine Learning for Polymer Simulations and Characterization. UW-Madison (Mar. 2026)
...
\begin{etaremune}
    \item AI agents for polymer simulations and small-angle scattering analysis. ACS Spring meeting, session on Analytics and AI For Chemistry, Manufacturing, and Healthcare. Atlanta (Mar. 2026)
    \item AI Agents for Topological Polymer Simulations and Small-Angle Scattering Analysis. APS Global Physics Summit, session on Progress in Advanced Characterization and Machine Learning Tools for Polymers. Denver (Mar. 2026)
...
\subsection*{Posters}
\begin{etaremune}
    \item Towards Autonomous Soft Matter Research. SAC meeting. ORNL (Jun. 2026)
...
\begin{itemize}
    ...
    \item I've served as reviewer for: Scientific Reports, Machine Learning with Application, Computational Economy, Journal of Materials Research, Macromolecular Theory and Simulations, Macromolecules, ACS Omega, AIP Advances, and Journal of Data and Information Science.
\end{itemize}
