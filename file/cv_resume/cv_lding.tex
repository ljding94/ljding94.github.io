...
\usepackage[left=0.75in, right=0.75in, top=0.75in, bottom=0.75in]{geometry} % margins
\usepackage{enumitem}
...
\begin{longtable}{l p{\linewidth}}
    ...
    Sep. 2016 - Dec. 2016    & Teaching Assistant (Mechanics and Thermal Physics), University of Science and Technology of China
\end{longtable}
