...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Programming:} Python (PyTorch, CrewAI, Agent SDK, NumPy, Pandas, Scikit-learn), C/C++,  SQL
\end{itemize}
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Agentic AI for Science:} Engineered multi-agent systems (CrewAI, Agent SDK, and Agent Skills) to orchestrate complex scientific workflows such as SAS data analysis, MD (LAMMPS) and MC (HOOMD-blue) simulations.
