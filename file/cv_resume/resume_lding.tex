...
\begin{itemize}[leftmargin=*]
    \item \textbf{Agentic AI for Science:} Engineered multi-agent systems (CrewAI, LangChain, and Agent Skills) to orchestrate complex scientific workflows such as SAS data analysis, MD (LAMMPS) and MC (HOOMD-blue) simulations.
